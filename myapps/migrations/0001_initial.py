    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latlong', location_field.models.plain.PlainLocationField(blank=True, max_length=63)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_type', models.CharField(choices=[('HOME_LOCATION_TYPE', 'HOME_LOCATION_TYPE'), ('OFFICE_LOCATION_TYPE', 'OFFICE_LOCATION_TYPE'), ('OTHER_LOCATION_TYPE', 'OTHER_LOCATION_TYPE')], default='HOME_LOCATION_TYPE', max_length=30)),
